// $ANTLR 3.5.1 /home/rycam/Documents/TLC/Projet_TLC/Grammar/While.g 2023-11-14 10:46:35
...
public class WhileParser extends DebugParser {
	...
	public static final String[] ruleNames = new String[] {
		"invalidRule", "commandNop", "inputSub", "vars", "definition", "commandEqual", 
		"commandForeach", "commands", "commandIf", "commandWhile", "lexpr", "command", 
		"exprBase1", "input", "function", "exprs", "output", "commandFor", "expression", 
		"exprBase2", "program", "exprBase3", "exprBase", "exprBase4"
	};
	...
	@Override public String getGrammarFileName() { return "/home/rycam/Documents/TLC/Projet_TLC/Grammar/While.g"; }
	...
	public final void function() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(13,4);
			match(input,20,FOLLOW_20_in_function90); dbg.location(13,15);
			match(input,Symbol,FOLLOW_Symbol_in_function92); dbg.location(13,22);
			match(input,10,FOLLOW_10_in_function94); dbg.location(13,26);
	...
	public final void definition() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(16,4);
			match(input,28,FOLLOW_28_in_definition106); dbg.location(16,11);
			pushFollow(FOLLOW_input_in_definition108);
			input();
			state._fsp--;
			dbg.location(16,17);
			match(input,6,FOLLOW_6_in_definition110); dbg.location(16,21);
			pushFollow(FOLLOW_commands_in_definition112);
			commands();
			state._fsp--;
			dbg.location(16,30);
			match(input,6,FOLLOW_6_in_definition114); dbg.location(16,34);
			match(input,32,FOLLOW_32_in_definition116); dbg.location(16,42);
	...
	public final void inputSub() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(22,4);
			match(input,Variable,FOLLOW_Variable_in_inputSub142); dbg.location(22,13);
			...
			switch (alt3) {
				case 1 :
					...
					{
					dbg.location(22,14);
					match(input,9,FOLLOW_9_in_inputSub145); dbg.location(22,18);
	...
	public final void output() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(25,4);
			match(input,Variable,FOLLOW_Variable_in_output160); dbg.location(25,13);
			...
			switch (alt4) {
				case 1 :
					...
					{
					dbg.location(25,14);
					match(input,9,FOLLOW_9_in_output163); dbg.location(25,18);
		...
		try {
			...
			switch (alt5) {
				case 1 :
					...
					{
					dbg.location(28,13);
					match(input,12,FOLLOW_12_in_commands180); dbg.location(28,17);
	...
	public final void commandNop() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(31,4);
			match(input,26,FOLLOW_26_in_commandNop195); 
			}
	...
	public final void commandEqual() throws RecognitionException {
		...
		try {
			...
			state._fsp--;
			dbg.location(34,9);
			match(input,11,FOLLOW_11_in_commandEqual207); dbg.location(34,14);
	...
	public final void commandIf() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(37,4);
			match(input,22,FOLLOW_22_in_commandIf219); dbg.location(37,9);
			pushFollow(FOLLOW_expression_in_commandIf221);
			expression();
			state._fsp--;
			dbg.location(37,20);
			match(input,29,FOLLOW_29_in_commandIf223); dbg.location(37,27);
			...
			switch (alt6) {
				case 1 :
					...
					{
					dbg.location(37,37);
					match(input,16,FOLLOW_16_in_commandIf228); dbg.location(37,44);
			...
			dbg.location(37,55);
			match(input,17,FOLLOW_17_in_commandIf234); 
			}
	...
	public final void commandWhile() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(40,4);
			match(input,31,FOLLOW_31_in_commandWhile244); dbg.location(40,12);
			pushFollow(FOLLOW_expression_in_commandWhile246);
			expression();
			state._fsp--;
			dbg.location(40,23);
			match(input,15,FOLLOW_15_in_commandWhile248); dbg.location(40,28);
			pushFollow(FOLLOW_commands_in_commandWhile250);
			commands();
			state._fsp--;
			dbg.location(40,37);
			match(input,27,FOLLOW_27_in_commandWhile252); 
			}
	...
	public final void commandFor() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(43,4);
			match(input,18,FOLLOW_18_in_commandFor262); dbg.location(43,10);
			pushFollow(FOLLOW_expression_in_commandFor264);
			expression();
			state._fsp--;
			dbg.location(43,21);
			match(input,15,FOLLOW_15_in_commandFor266); dbg.location(43,26);
			pushFollow(FOLLOW_commands_in_commandFor268);
			commands();
			state._fsp--;
			dbg.location(43,35);
			match(input,27,FOLLOW_27_in_commandFor270); 
			}
	...
	public final void commandForeach() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(46,4);
			match(input,19,FOLLOW_19_in_commandForeach280); dbg.location(46,14);
			match(input,Variable,FOLLOW_Variable_in_commandForeach282); dbg.location(46,23);
			match(input,23,FOLLOW_23_in_commandForeach284); dbg.location(46,28);
			pushFollow(FOLLOW_expression_in_commandForeach286);
			expression();
			state._fsp--;
			dbg.location(46,39);
			match(input,15,FOLLOW_15_in_commandForeach288); dbg.location(46,44);
			pushFollow(FOLLOW_commands_in_commandForeach290);
			commands();
			state._fsp--;
			dbg.location(46,53);
			match(input,27,FOLLOW_27_in_commandForeach292); 
			}
	...
	public final void vars() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(52,4);
			match(input,Variable,FOLLOW_Variable_in_vars332); dbg.location(52,13);
			...
			switch (alt8) {
				case 1 :
					...
					{
					dbg.location(52,14);
					match(input,9,FOLLOW_9_in_vars335); dbg.location(52,18);
		...
		try {
			...
			switch (alt9) {
				case 1 :
					...
					{
					dbg.location(55,16);
					match(input,9,FOLLOW_9_in_exprs352); dbg.location(55,20);
		...
		try {
			...
			switch (alt10) {
				case 1 :
					...
					{
					dbg.location(61,4);
					match(input,7,FOLLOW_7_in_exprBase2384); dbg.location(61,8);
					match(input,14,FOLLOW_14_in_exprBase2386); dbg.location(61,15);
					pushFollow(FOLLOW_lexpr_in_exprBase2388);
					lexpr();
					state._fsp--;
					dbg.location(61,21);
					match(input,8,FOLLOW_8_in_exprBase2390); 
					}
					break;
				case 2 :
					dbg.enterAlt(2);
					...
					{
					dbg.location(61,27);
					match(input,7,FOLLOW_7_in_exprBase2394); dbg.location(61,31);
					match(input,24,FOLLOW_24_in_exprBase2396); dbg.location(61,38);
					pushFollow(FOLLOW_lexpr_in_exprBase2398);
					lexpr();
					state._fsp--;
					dbg.location(61,44);
					match(input,8,FOLLOW_8_in_exprBase2400); 
					}
					break;
		...
		try {
			...
			switch (alt11) {
				case 1 :
					...
					{
					dbg.location(64,4);
					match(input,7,FOLLOW_7_in_exprBase3410); dbg.location(64,8);
					match(input,21,FOLLOW_21_in_exprBase3412); dbg.location(64,13);
					pushFollow(FOLLOW_exprBase_in_exprBase3414);
					exprBase();
					state._fsp--;
					dbg.location(64,22);
					match(input,8,FOLLOW_8_in_exprBase3416); 
					}
					break;
				case 2 :
					dbg.enterAlt(2);
					...
					{
					dbg.location(64,28);
					match(input,7,FOLLOW_7_in_exprBase3420); dbg.location(64,32);
					match(input,30,FOLLOW_30_in_exprBase3422); dbg.location(64,37);
					pushFollow(FOLLOW_exprBase_in_exprBase3424);
					exprBase();
					state._fsp--;
					dbg.location(64,46);
					match(input,8,FOLLOW_8_in_exprBase3426); 
					}
					break;
	...
	public final void exprBase4() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(67,4);
			match(input,7,FOLLOW_7_in_exprBase4436); dbg.location(67,8);
			match(input,Symbol,FOLLOW_Symbol_in_exprBase4438); dbg.location(67,15);
			pushFollow(FOLLOW_lexpr_in_exprBase4440);
			lexpr();
			state._fsp--;
			dbg.location(67,21);
			match(input,8,FOLLOW_8_in_exprBase4442); 
			}
	...
	public final void exprBase() throws RecognitionException {
		...
		try {
			...
			if ( ((LA12_0 >= Symbol && LA12_0 <= Variable)||LA12_0==25) ) {
				alt12=1;
			}
			else if ( (LA12_0==7) ) {
				switch ( input.LA(2) ) {
		...
		try {
			...
			switch (alt13) {
				case 1 :
					...
					{
					dbg.location(73,14);
					match(input,13,FOLLOW_13_in_expression477); dbg.location(73,19);
	...
	public final void lexpr() throws RecognitionException {
		...
		try {
			...
			if ( ((LA14_0 >= Symbol && LA14_0 <= Variable)||LA14_0==7||LA14_0==25) ) {
				alt14=1;
			}
			else if ( (LA14_0==8) ) {
				alt14=2;
	...
	public static final BitSet FOLLOW_function_in_program77 = new BitSet(new long[]{0x0000000000100002L});
	public static final BitSet FOLLOW_program_in_program79 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_function90 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_Symbol_in_function92 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_function94 = new BitSet(new long[]{0x0000000010000000L});
	public static final BitSet FOLLOW_definition_in_function96 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_28_in_definition106 = new BitSet(new long[]{0x0000000000000060L});
	public static final BitSet FOLLOW_input_in_definition108 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_6_in_definition110 = new BitSet(new long[]{0x00000000844C0020L});
	public static final BitSet FOLLOW_commands_in_definition112 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_6_in_definition114 = new BitSet(new long[]{0x0000000100000000L});
	public static final BitSet FOLLOW_32_in_definition116 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_Variable_in_inputSub142 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_9_in_inputSub145 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_inputSub_in_inputSub147 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_Variable_in_output160 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_9_in_output163 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_12_in_commands180 = new BitSet(new long[]{0x00000000844C0020L});
	public static final BitSet FOLLOW_commands_in_commands182 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_26_in_commandNop195 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_vars_in_commandEqual205 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_commandEqual207 = new BitSet(new long[]{0x00000000020000B0L});
	public static final BitSet FOLLOW_exprs_in_commandEqual209 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_22_in_commandIf219 = new BitSet(new long[]{0x00000000020000B0L});
	public static final BitSet FOLLOW_expression_in_commandIf221 = new BitSet(new long[]{0x0000000020000000L});
	public static final BitSet FOLLOW_29_in_commandIf223 = new BitSet(new long[]{0x00000000844C0020L});
	public static final BitSet FOLLOW_commands_in_commandIf225 = new BitSet(new long[]{0x0000000000030000L});
	public static final BitSet FOLLOW_16_in_commandIf228 = new BitSet(new long[]{0x00000000844C0020L});
	public static final BitSet FOLLOW_commands_in_commandIf230 = new BitSet(new long[]{0x0000000000020000L});
	public static final BitSet FOLLOW_17_in_commandIf234 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_31_in_commandWhile244 = new BitSet(new long[]{0x00000000020000B0L});
	public static final BitSet FOLLOW_expression_in_commandWhile246 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_commandWhile248 = new BitSet(new long[]{0x00000000844C0020L});
	public static final BitSet FOLLOW_commands_in_commandWhile250 = new BitSet(new long[]{0x0000000008000000L});
	public static final BitSet FOLLOW_27_in_commandWhile252 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_18_in_commandFor262 = new BitSet(new long[]{0x00000000020000B0L});
	public static final BitSet FOLLOW_expression_in_commandFor264 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_commandFor266 = new BitSet(new long[]{0x00000000844C0020L});
	public static final BitSet FOLLOW_commands_in_commandFor268 = new BitSet(new long[]{0x0000000008000000L});
	public static final BitSet FOLLOW_27_in_commandFor270 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_19_in_commandForeach280 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_Variable_in_commandForeach282 = new BitSet(new long[]{0x0000000000800000L});
	public static final BitSet FOLLOW_23_in_commandForeach284 = new BitSet(new long[]{0x00000000020000B0L});
	public static final BitSet FOLLOW_expression_in_commandForeach286 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_commandForeach288 = new BitSet(new long[]{0x00000000844C0020L});
	public static final BitSet FOLLOW_commands_in_commandForeach290 = new BitSet(new long[]{0x0000000008000000L});
	public static final BitSet FOLLOW_27_in_commandForeach292 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_Variable_in_vars332 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_9_in_vars335 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_vars_in_vars337 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expression_in_exprs349 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_9_in_exprs352 = new BitSet(new long[]{0x00000000020000B0L});
	public static final BitSet FOLLOW_exprs_in_exprs354 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_7_in_exprBase2384 = new BitSet(new long[]{0x0000000000004000L});
	public static final BitSet FOLLOW_14_in_exprBase2386 = new BitSet(new long[]{0x00000000020001B0L});
	public static final BitSet FOLLOW_lexpr_in_exprBase2388 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_exprBase2390 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_7_in_exprBase2394 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_24_in_exprBase2396 = new BitSet(new long[]{0x00000000020001B0L});
	public static final BitSet FOLLOW_lexpr_in_exprBase2398 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_exprBase2400 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_7_in_exprBase3410 = new BitSet(new long[]{0x0000000000200000L});
	public static final BitSet FOLLOW_21_in_exprBase3412 = new BitSet(new long[]{0x00000000020000B0L});
	public static final BitSet FOLLOW_exprBase_in_exprBase3414 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_exprBase3416 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_7_in_exprBase3420 = new BitSet(new long[]{0x0000000040000000L});
	public static final BitSet FOLLOW_30_in_exprBase3422 = new BitSet(new long[]{0x00000000020000B0L});
	public static final BitSet FOLLOW_exprBase_in_exprBase3424 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_exprBase3426 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_7_in_exprBase4436 = new BitSet(new long[]{0x0000000000000010L});
	public static final BitSet FOLLOW_Symbol_in_exprBase4438 = new BitSet(new long[]{0x00000000020001B0L});
	public static final BitSet FOLLOW_lexpr_in_exprBase4440 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_8_in_exprBase4442 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_exprBase_in_expression474 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_13_in_expression477 = new BitSet(new long[]{0x00000000020000B0L});
	public static final BitSet FOLLOW_exprBase_in_expression479 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exprBase_in_lexpr491 = new BitSet(new long[]{0x00000000020000B0L});
